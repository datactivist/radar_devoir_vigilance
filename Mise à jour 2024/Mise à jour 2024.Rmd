...
Enfin, les entreprises qui publient un plan (reconnaissant ainsi être soumises à la loi sur le devoir de vigilance) ont été ajoutées, de même que certaines autres sociétés à la suite de signalements par des tiers. Celles-ci apparaissent uniquement dans la "liste finale", avec la source "*Publie un plan*". 

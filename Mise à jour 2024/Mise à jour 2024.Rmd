...
- **Nombre d'employés** : *5.000 et plus* pour les trois dernières années disponibles, pour un total de **7.827** entreprises.

Seules 139 entreprises remplissent les deux caractéristiques listées. 
